...
@onready var enemy_audio: AudioStreamPlayer2D = $EnemyAudioPlayer

# Audio streams
const CORRUPT_SOUND = preload("res://assets/audio/sfx/spores.mp3")
